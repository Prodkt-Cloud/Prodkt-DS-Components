(() => {
  ...
  const isNext = location.hostname === 'next.prodkt.cloud';
        ...
        ${props
          .map(prop => {
            ...
            if (!hasAttribute) {
              ...
              attributeInfo = `
                <br>
                <moyo-tooltip content="This attribute is different from its property">
                  <small>
                    <code class="nowrap">
            ...
            return `
              <tr>
                ...
                <td style="text-align: center;">${
                  prop.reflects ? '<moyo-icon label="yes" name="check"></moyo-icon>' : ''
                }</td>
        ...
        result += `
          <div class="component-header">
            ...
            <div class="component-header__info">
              <moyo-badge variant="neutral" pill>
                Since ${component.since || '?'}
              </moyo-badge>

              <moyo-badge variant="${badgeType}" pill style="text-transform: capitalize;">
                ${component.status}
              </moyo-badge>
            </div>
          </div>
      ...
      content = content.replace(/\[component-metadata:([a-z-]+)\]/g, (match, tag) => {
        ...
        if (component.path) {
          ...
          result += `
            ...
            <moyo-tab-group>
            <moyo-tab slot="nav" panel="script">Script</moyo-tab>
            <moyo-tab slot="nav" panel="import">Import</moyo-tab>
            <moyo-tab slot="nav" panel="bundler">Bundler</moyo-tab>
            <moyo-tab slot="nav" panel="react">React</moyo-tab>

            <moyo-tab-panel name="script">\n
            To import this component from [the CDN](https://www.jsdelivr.com/package/npm/@tovutifunk/tovuti) using a script tag:

            \`\`\`html
            <script type="module" src="https://cdn.jsdelivr.net/npm/@tovutifunk/tovuti@${metadata.package.version}/${component.path}"></script>
            \`\`\`
            </moyo-tab-panel>

            <moyo-tab-panel name="import">\n
            To import this component from [the CDN](https://www.jsdelivr.com/package/npm/@tovutifunk/tovuti) using a JavaScript import:

            \`\`\`js
            import 'https://cdn.jsdelivr.net/npm/@tovutifunk/tovuti@${metadata.package.version}/${component.path}';
            \`\`\`
            </moyo-tab-panel>

            <moyo-tab-panel name="bundler">\n
            To import this component using [a bundler](/getting-started/installation#bundling):
            \`\`\`js
            import '@tovutifunk/tovuti/${component.path}';
            \`\`\`
            </moyo-tab-panel>

            <moyo-tab-panel name="react">\n
            To import this component as a [React component](/frameworks/react):
            \`\`\`js
            import { ${component.name} } from '@tovutifunk/tovuti/dist/react';
            \`\`\`
            </moyo-tab-panel>
            </moyo-tab-group>
          `;
