...
MoyoMenu.styles = menu_styles_default;
__decorateClass([
  i(".menu")
], MoyoMenu.prototype, "menu", 2);
__decorateClass([
  i("slot")
], MoyoMenu.prototype, "defaultSlot", 2);
MoyoMenu = __decorateClass([
  n("moyo-menu")
], MoyoMenu);
