...
[component-header:moyo-image-comparer]
...
```jsx react
import { MoyoImageComparer } from '@tovutifunk/tovuti/dist/react';
...
```html preview
<moyo-image-comparer position="25">
  <img
    slot="before"
  ...
  <img
    ...
    alt="A person sitting on a yellow curb tying tovutis on a boot."
  />
</moyo-image-comparer>
```
...
[component-metadata:moyo-image-comparer]
