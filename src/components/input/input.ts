 ...
 *
 * @event moyo-change - Emitted when an alteration to the control's value is committed by the user.
 * @event moyo-clear - Emitted when the clear button is activated.
 * @event moyo-input - Emitted when the control receives input and its value changes.
 ...
 */
@customElement('moyo-input')
export default class MoyoInput extends LitElement {
