...
import type MoyoDrawer from './drawer';

describe('<moyo-drawer>', () => {
  it('should be visible with the open attribute', async () => {
    const el = await fixture<MoyoDrawer>(html`
      <moyo-drawer open>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</moyo-drawer>
    `);
  ...
  it('should not be visible without the open attribute', async () => {
    const el = await fixture<MoyoDrawer>(
      html` <moyo-drawer>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</moyo-drawer> `
    );
    const base = el.shadowRoot!.querySelector<HTMLElement>('[part="base"]')!;
  ...
  it('should emit moyo-show and moyo-after-show when calling show()', async () => {
    const el = await fixture<MoyoDrawer>(html`
      <moyo-drawer>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</moyo-drawer>
    `);
    const base = el.shadowRoot!.querySelector<HTMLElement>('[part="base"]')!;
  ...
  it('should allow initial focus to be set', async () => {
    const el = await fixture<MoyoDrawer>(html` <moyo-drawer><input /></moyo-drawer> `);
