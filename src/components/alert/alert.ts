...
const toastStack = Object.assign(document.createElement('div'), { className: 'moyo-toast-stack' });
 ...
 *
 * @event moyo-show - Emitted when the alert opens.
 * @event moyo-after-show - Emitted after the alert opens and all animations are complete.
 * @event moyo-hide - Emitted when the alert closes.
 * @event moyo-after-hide - Emitted after the alert closes and all animations are complete.
 *
...
@customElement('moyo-alert')
export default class MoyoAlert extends LitElement {
