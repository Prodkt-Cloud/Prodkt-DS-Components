 ...
 */
@customElement('moyo-button')
export default class MoyoButton extends LitElement {
  ...
  render() {
    ...
    return html`
      ...
      >
        ...
        ${this.loading ? html`<moyo-spinner></moyo-spinner>` : ''}
      </${tag}>
    `;
