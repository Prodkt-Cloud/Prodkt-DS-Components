...
import type MoyoButton from './button';

const variants = ['default', 'primary', 'success', 'neutral', 'warning', 'danger'];

describe('<moyo-button>', () => {
  describe('accessibility tests', () => {
    variants.forEach(variant => {
      it(`should be accessible when variant is "${variant}"`, async () => {
        const el = await fixture<MoyoButton>(html` <moyo-button variant="${variant}"> Button Label </moyo-button> `);
  ...
  describe('when provided no parameters', () => {
    it('passes accessibility test', async () => {
      const el = await fixture<MoyoButton>(html` <moyo-button>Button Label</moyo-button> `);
      await expect(el).to.be.accessible();
    });
    ...
    it('should not have a spinner present', async () => {
      const el = await fixture<MoyoButton>(html` <moyo-button>Button Label</moyo-button> `);
      expect(el.shadowRoot!.querySelector('moyo-spinner')).not.to.exist;
    });
  ...
  describe('when disabled', () => {
    it('passes accessibility test', async () => {
      const el = await fixture<MoyoButton>(html` <moyo-button disabled>Button Label</moyo-button> `);
      await expect(el).to.be.accessible();
    });
    ...
    it('should not disable the native <a> when rendering an <a>', async () => {
      const el = await fixture<MoyoButton>(html` <moyo-button href="some/path" disabled>Button Label</moyo-button> `);
      expect(el.shadowRoot!.querySelector('a[disabled]')).not.to.exist;
    });

    it('should not bubble up clicks', async () => {
      const button = await fixture<MoyoButton>(html` <moyo-button disabled>Button Label</moyo-button> `);
  ...
  describe('when loading', () => {
    it('should have a spinner present', async () => {
      const el = await fixture<MoyoButton>(html` <moyo-button loading>Button Label</moyo-button> `);
      expect(el.shadowRoot!.querySelector('moyo-spinner')).to.exist;
    });
  });

  describe('when caret', () => {
    it('should have a caret present', async () => {
      const el = await fixture<MoyoButton>(html` <moyo-button caret>Button Label</moyo-button> `);
  ...
  describe('when href is present', () => {
    it('should render as an <a>', async () => {
      const el = await fixture<MoyoButton>(html` <moyo-button href="some/path">Button Label</moyo-button> `);
  ...
  describe('when submitting a form', () => {
    it('should submit when the button is inside the form', async () => {
      ...
      `);
      const button = form.querySelector<MoyoButton>('moyo-button')!;
    ...
    it('should submit when the button is outside the form and has a form attribute', async () => {
      const el = await fixture(html`
        <div>
          ...
          <moyo-button type="submit" form="a">Submit</moyo-button>
        </div>
      `);
      const form = el.querySelector<HTMLFormElement>('form')!;
      const button = el.querySelector<MoyoButton>('moyo-button')!;
      const handleSubmit = sinon.spy((event: SubmitEvent) => event.preventDefault());
    ...
    it('should override form attributes when formaction, formmethod, formnovalidate, and formtarget are used inside a form', async () => {
      const form = await fixture(html`
        <form id="a" action="foo" method="POST" target="_self">
          <moyo-button type="submit" form="a" formaction="bar" formmethod="get" formtarget="_blank" formnovalidate>
            Submit
          </moyo-button>
        </form>
      `);
  ...
  describe('when using methods', () => {
    it('should emit moyo-focus and moyo-blur when the button is focused and blurred', async () => {
      const el = await fixture<MoyoButton>(html` <moyo-button>Button</moyo-button> `);
    ...
    it('should emit a click event when calling click()', async () => {
      const el = await fixture<MoyoButton>(html` <moyo-button></moyo-button> `);
