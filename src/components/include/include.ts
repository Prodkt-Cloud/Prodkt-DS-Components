 ...
 * @status stable
 *
 * @event moyo-load - Emitted when the included file is loaded.
 * @event {{ status: number }} moyo-error - Emitted when the included file fails to load due to an error.
 */
@customElement('moyo-include')
export default class MoyoInclude extends LitElement {
