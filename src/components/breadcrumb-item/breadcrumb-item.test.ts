...
import type MoyoBreadcrumbItem from './breadcrumb-item';

describe('<moyo-breadcrumb-item>', () => {
  let el: MoyoBreadcrumbItem;

  describe('when not provided a href attribute', () => {
    before(async () => {
      el = await fixture<MoyoBreadcrumbItem>(html` <moyo-breadcrumb-item>Home</moyo-breadcrumb-item> `);
    });
  ...
  describe('when provided a href attribute', () => {
    describe('and no target', () => {
      before(async () => {
        el = await fixture<MoyoBreadcrumbItem>(html`
          <moyo-breadcrumb-item href="https://jsonplaceholder.typicode.com/">Home</moyo-breadcrumb-item>
        `);
      });
    ...
    describe('and target, without rel', () => {
      before(async () => {
        el = await fixture<MoyoBreadcrumbItem>(html`
          <moyo-breadcrumb-item href="https://jsonplaceholder.typicode.com/" target="_blank">Help</moyo-breadcrumb-item>
        `);
      });
    ...
    describe('and target, with rel', () => {
      before(async () => {
        el = await fixture<MoyoBreadcrumbItem>(html`
          <moyo-breadcrumb-item href="https://jsonplaceholder.typicode.com/" target="_blank" rel="alternate"
            >Help</moyo-breadcrumb-item
          >
        `);
      });
