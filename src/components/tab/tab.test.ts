...
import type MoyoTab from './tab';

describe('<moyo-tab>', () => {
  it('should render default tab', async () => {
    const el = await fixture<MoyoTab>(html` <moyo-tab>Test</moyo-tab> `);
  ...
  it('should disable tab by attribute', async () => {
    const el = await fixture<MoyoTab>(html` <moyo-tab disabled>Test</moyo-tab> `);
  ...
  it('should set active tab by attribute', async () => {
    const el = await fixture<MoyoTab>(html` <moyo-tab active>Test</moyo-tab> `);
  ...
  it('should set closable by attribute', async () => {
    const el = await fixture<MoyoTab>(html` <moyo-tab closable>Test</moyo-tab> `);
  ...
  describe('closable', () => {
    it('should emit close event when close button clicked', async () => {
      ...
      el.addEventListener('moyo-close', spy, { once: true });
