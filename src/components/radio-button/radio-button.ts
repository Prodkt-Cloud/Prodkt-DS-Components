 ...
 *
 * @event moyo-blur - Emitted when the button loses focus.
 * @event moyo-change - Emitted when the button's checked state changes.
 * @event moyo-focus - Emitted when the button gains focus.
 *
 ...
 */
@customElement('moyo-radio-button')
export default class MoyoRadioButton extends LitElement {
  ...
  protected readonly formSubmitController = new FormSubmitController(this, {
    value: (control: MoyoRadioButton) => (control.checked ? control.value : undefined)
  });
...
declare global {
  interface HTMLElementTagNameMap {
    'moyo-radio-button': MoyoRadioButton;
  }
}
