 ...
 *
 * @event moyo-label-change - Emitted when the menu item's text label changes. For performance reasons, this event is only
 ...
 */
@customElement('moyo-menu-item')
export default class MoyoMenuItem extends LitElement {
