 ...
 *
 * @event moyo-show - Emitted when the tooltip begins to show.
 * @event moyo-after-show - Emitted after the tooltip has shown and all animations are complete.
 * @event moyo-hide - Emitted when the tooltip begins to hide.
 * @event moyo-after-hide - Emitted after the tooltip has hidden and all animations are complete.
 *
 ...
 */
@customElement('moyo-tooltip')
export default class MoyoTooltip extends LitElement {
