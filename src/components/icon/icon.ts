 ...
 * @status stable
 *
 * @event moyo-load - Emitted when the icon has loaded.
 * @event moyo-error - Emitted when the icon fails to load due to an error.
 *
 * @csspart base - The component's internal wrapper.
 */
@customElement('moyo-icon')
export default class MoyoIcon extends LitElement {
