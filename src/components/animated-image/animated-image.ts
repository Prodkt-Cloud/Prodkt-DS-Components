 ...
 *
 * @event moyo-load - Emitted when the image loads successfully.
 * @event moyo-error - Emitted when the image fails to load.
 *
 ...
 */
@customElement('moyo-animated-image')
export default class MoyoAnimatedImage extends LitElement {
        ...
        ${this.isLoaded
          ? html`
              ...
              <div part="control-box" class="animated-image__control-box">
                ${this.play
                  ? html`<moyo-icon part="pause-icon" name="pause-fill" library="system"></moyo-icon>`
                  : html`<moyo-icon part="play-icon" name="play-fill" library="system"></moyo-icon>`}
              </div>
            `
          : ''}
      </div>
...
declare global {
  interface HTMLElementTagNameMap {
    'moyo-animated-image': MoyoAnimatedImage;
  }
}
