 ...
 *
 * @event moyo-change - Emitted when the rating's value changes.
 *
 ...
 */
@customElement('moyo-rating')
export default class MoyoRating extends LitElement {
  ...
  @property() getSymbol: (value: number) => string = () => '<moyo-icon name="star-fill" library="system"></moyo-icon>';
