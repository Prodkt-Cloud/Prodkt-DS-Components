 ...
 * @status stable
 *
 * @event moyo-cancel - Emitted when the animation is canceled.
 * @event moyo-finish - Emitted when the animation finishes.
 * @event moyo-start - Emitted when the animation starts or restarts.
 *
 ...
 */
@customElement('moyo-animation')
export default class MoyoAnimation extends LitElement {
  ...
  /**
   * The easing function to use for the animation. This can be a Tovuti easing function or a custom easing function
