...
import type MoyoDropdown from '../../components/dropdown/dropdown';
 ...
 *
 * @event moyo-clear - Emitted when the clear button is activated.
 * @event moyo-change - Emitted when the control's value changes.
 * @event moyo-focus - Emitted when the control gains focus.
 * @event moyo-blur - Emitted when the control loses focus.
 *
 ...
 * @csspart menu - The select menu, an `<moyo-menu>` element.
 * @csspart tag - The multi select option, an `<moyo-tag>` element.
 ...
 */
@customElement('moyo-select')
export default class MoyoSelect extends LitElement {
  static styles = styles;

  @query('.select') dropdown: MoyoDropdown;
  @query('.select__control') control: MoyoDropdown;
  @query('.select__hidden-select') input: HTMLInputElement;
  @query('.select__menu') menu: MoyoMenu;

  // @ts-expect-error -- Controller is currently unused
  private readonly formSubmitController = new FormSubmitController(this);
  private readonly hasSlotController = new HasSlotController(this, 'help-text', 'label');
  private readonly localize = new LocalizeController(this);
  private menuItems: MoyoMenuItem[] = [];
  ...
  async handleMenuSlotChange() {
    ...
    this.menuItems = [...this.querySelectorAll<MoyoMenuItem>('moyo-menu-item')];
  ...
  handleTagInteraction(event: KeyboardEvent | MouseEvent) {
    ...
    const clearButton = path.find((el: MoyoIconButton) => {
  ...
  syncItemsFromValue() {
    ...
    if (this.multiple) {
      ...
      this.displayTags = checkedItems.map((item: MoyoMenuItem) => {
        return html`
          <moyo-tag
            part="tag"
            exportparts="
