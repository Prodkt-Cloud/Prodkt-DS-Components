...
import type MoyoInput from '../../components/input/input';
 ...
 * @status stable
 *
 * @dependency moyo-button
 * @dependency moyo-button-group
 * @dependency moyo-dropdown
 * @dependency moyo-input
 * @dependency moyo-visually-hidden
 *
 * @slot label - The color picker's label. Alternatively, you can use the label prop.
 *
 * @event moyo-change Emitted when the color picker's value changes.
 *
 ...
 */
@customElement('moyo-color-picker')
export default class MoyoColorPicker extends LitElement {
  static styles = styles;

  @query('[part="input"]') input: MoyoInput;
  @query('[part="preview"]') previewButton: HTMLButtonElement;
  @query('.color-dropdown') dropdown: MoyoDropdown;
...
declare global {
  interface HTMLElementTagNameMap {
    'moyo-color-picker': MoyoColorPicker;
  }
}
