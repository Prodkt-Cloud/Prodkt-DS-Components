...
import type MoyoProgressBar from './progress-bar';

describe('<moyo-progress-bar>', () => {
  let el: MoyoProgressBar;

  describe('when provided just a value parameter', () => {
    before(async () => {
      el = await fixture<MoyoProgressBar>(html`<moyo-progress-bar value="25"></moyo-progress-bar>`);
    });
  ...
  describe('when provided a title, and value parameter', () => {
    ...
    before(async () => {
      el = await fixture<MoyoProgressBar>(
        html`<moyo-progress-bar title="Titled Progress Ring" value="25"></moyo-progress-bar>`
      );
  ...
  describe('when provided an indeterminate parameter', () => {
    ...
    before(async () => {
      el = await fixture<MoyoProgressBar>(
        html`<moyo-progress-bar title="Titled Progress Ring" indeterminate></moyo-progress-bar>`
      );
      base = el.shadowRoot!.querySelector('[part="base"]')!;
    });
  ...
  describe('when provided a ariaLabel, and value parameter', () => {
    before(async () => {
      el = await fixture<MoyoProgressBar>(
        html`<moyo-progress-bar ariaLabel="Labelled Progress Ring" value="25"></moyo-progress-bar>`
      );
    });
    ...
    before(async () => {
      el = await fixture<MoyoProgressBar>(
        html`
          ...
          <moyo-progress-bar ariaLabelledBy="labelledby" value="25"></moyo-progress-bar>
        `
      );
    });
