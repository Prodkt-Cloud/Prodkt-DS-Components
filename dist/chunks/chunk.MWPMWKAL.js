...
var color_picker_styles_default = r`
  ...
  .color-picker--inline${focusVisibleSelector} {
    outline: none;
    box-shadow: 0 0 0 1px var(--moyo-color-primary-500), var(--moyo-focus-ring);
  }
  ...
  .color-picker__grid {
    ...
    border-top-left-radius: var(--moyo-border-radius-medium);
    border-top-right-radius: var(--moyo-border-radius-medium);
    cursor: crosshair;
  }
  ...
  .color-picker__controls {
    padding: var(--moyo-spacing-small);
    display: flex;
    align-items: center;
  }
  ...
  .color-picker__slider:not(:last-of-type) {
    margin-bottom: var(--moyo-spacing-small);
  }
  ...
  .color-picker__preview {
    ...
    background: none;
    margin-left: var(--moyo-spacing-small);
    cursor: copy;
  }
  ...
  @keyframes pulse {
    0% {
      box-shadow: 0 0 0 0 var(--moyo-color-primary-500);
    }
    70% {
  ...
  .color-picker__user-input {
    display: flex;
    padding: 0 var(--moyo-spacing-small) var(--moyo-spacing-small) var(--moyo-spacing-small);
  }

  .color-picker__user-input moyo-input {
    min-width: 0; /* fix input width in Safari */
    flex: 1 1 auto;
  }

  .color-picker__user-input moyo-button-group {
    margin-left: var(--moyo-spacing-small);
  }

  .color-picker__user-input moyo-button {
    min-width: 3.25rem;
    max-width: 3.25rem;
    font-size: 1rem;
  }
  ...
  .color-picker__transparent-bg {
    background-image: linear-gradient(45deg, var(--moyo-color-neutral-300) 25%, transparent 25%),
      linear-gradient(45deg, transparent 75%, var(--moyo-color-neutral-300) 75%),
      linear-gradient(45deg, transparent 75%, var(--moyo-color-neutral-300) 75%),
      linear-gradient(45deg, var(--moyo-color-neutral-300) 25%, transparent 25%);
  ...
  .color-dropdown__trigger {
    ...
    border: none;
    cursor: pointer;
    transition: var(--moyo-transition-fast) box-shadow;
  }
  ...
  .color-dropdown__trigger:before {
    ...
    box-shadow: inset 0 0 0 2px var(--moyo-input-border-color), inset 0 0 0 4px var(--moyo-color-neutral-0);
    transition: inherit;
  }
  ...
  .color-dropdown__trigger${focusVisibleSelector}:not(.color-dropdown__trigger--disabled):before {
    box-shadow: inset 0 0 0 1px var(--moyo-color-primary-500);
  }
