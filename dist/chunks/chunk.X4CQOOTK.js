...
var o = async (t2, e2, n3) => {
  ...
  for (let n4 = 0; n4 < a3.length; n4++) {
    ...
    f3 = y3 != null ? y3 : f3, u3 = x3 != null ? x3 : u3, g3 = __spreadProps(__spreadValues({}, g3), { [p3]: __spreadValues(__spreadValues({}, g3[p3]), w3) }), v3 && d3 <= 50 && (d3++, typeof v3 == "object" && (v3.placement && (m3 = v3.placement), v3.rects && (c3 = v3.rects === true ? await l3.getElementRects({ reference: t2, floating: e2, strategy: o3 }) : v3.rects), { x: f3, y: u3 } = i(c3, m3, s3)), n4 = -1);
  }
