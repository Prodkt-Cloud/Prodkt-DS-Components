...
var MoyoQrCode = class extends s {
  constructor() {
    super(...arguments);
    this.value = "";
    this.label = "";
...
MoyoQrCode.styles = qr_code_styles_default;
__decorateClass([
  i("canvas")
], MoyoQrCode.prototype, "canvas", 2);
__decorateClass([
  e()
], MoyoQrCode.prototype, "value", 2);
__decorateClass([
  e()
], MoyoQrCode.prototype, "label", 2);
__decorateClass([
  e({ type: Number })
], MoyoQrCode.prototype, "size", 2);
__decorateClass([
  e()
], MoyoQrCode.prototype, "fill", 2);
__decorateClass([
  e()
], MoyoQrCode.prototype, "background", 2);
__decorateClass([
  e({ type: Number })
], MoyoQrCode.prototype, "radius", 2);
__decorateClass([
  e({ attribute: "error-correction" })
], MoyoQrCode.prototype, "errorCorrection", 2);
__decorateClass([
  watch("background"),
  ...
  watch("size"),
  watch("value")
], MoyoQrCode.prototype, "generate", 1);
MoyoQrCode = __decorateClass([
  n("moyo-qr-code")
], MoyoQrCode);
