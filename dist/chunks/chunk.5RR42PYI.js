...
var MoyoColorPicker = class extends s {
  constructor() {
    super(...arguments);
  ...
  reportValidity() {
    if (!this.inline && this.input.invalid) {
      return new Promise((resolve) => {
        this.dropdown.addEventListener("moyo-after-show", () => {
  ...
  render() {
      ...
      "--preview-color": `hsla(${this.hue}deg, ${this.saturation}%, ${this.lightness}%, ${this.alpha / 100})`
        ...
        <div class="color-picker__user-input" aria-live="polite">
          <moyo-input
            ...
            @moyo-change=${this.handleInputChange}
          ></moyo-input>
    ...
    return $`
      <moyo-dropdown
        ...
        ?disabled=${this.disabled}
        ?hoist=${this.hoist}
        @moyo-after-hide=${this.handleAfterHide}
      >
        <button
          part="trigger"
          slot="trigger"
...
MoyoColorPicker.styles = color_picker_styles_default;
__decorateClass([
  i('[part="input"]')
], MoyoColorPicker.prototype, "input", 2);
__decorateClass([
  i('[part="preview"]')
], MoyoColorPicker.prototype, "previewButton", 2);
__decorateClass([
  i(".color-dropdown")
], MoyoColorPicker.prototype, "dropdown", 2);
__decorateClass([
  t()
], MoyoColorPicker.prototype, "inputValue", 2);
__decorateClass([
  t()
], MoyoColorPicker.prototype, "hue", 2);
__decorateClass([
  t()
], MoyoColorPicker.prototype, "saturation", 2);
__decorateClass([
  t()
], MoyoColorPicker.prototype, "lightness", 2);
__decorateClass([
  t()
], MoyoColorPicker.prototype, "alpha", 2);
__decorateClass([
  e()
], MoyoColorPicker.prototype, "value", 2);
__decorateClass([
  e()
], MoyoColorPicker.prototype, "label", 2);
__decorateClass([
  e()
], MoyoColorPicker.prototype, "format", 2);
__decorateClass([
  e({ type: Boolean, reflect: true })
], MoyoColorPicker.prototype, "inline", 2);
__decorateClass([
  e()
], MoyoColorPicker.prototype, "size", 2);
__decorateClass([
  e({ attribute: "no-format-toggle", type: Boolean })
], MoyoColorPicker.prototype, "noFormatToggle", 2);
__decorateClass([
  e()
], MoyoColorPicker.prototype, "name", 2);
__decorateClass([
  e({ type: Boolean, reflect: true })
], MoyoColorPicker.prototype, "disabled", 2);
__decorateClass([
  e({ type: Boolean, reflect: true })
], MoyoColorPicker.prototype, "invalid", 2);
__decorateClass([
  e({ type: Boolean })
], MoyoColorPicker.prototype, "hoist", 2);
__decorateClass([
  e({ type: Boolean })
], MoyoColorPicker.prototype, "opacity", 2);
__decorateClass([
  e({ type: Boolean })
], MoyoColorPicker.prototype, "uppercase", 2);
__decorateClass([
  e({ attribute: false })
], MoyoColorPicker.prototype, "swatches", 2);
__decorateClass([
  e()
], MoyoColorPicker.prototype, "lang", 2);
__decorateClass([
  watch("format")
], MoyoColorPicker.prototype, "handleFormatChange", 1);
__decorateClass([
  watch("opacity")
], MoyoColorPicker.prototype, "handleOpacityChange", 1);
__decorateClass([
  watch("value")
], MoyoColorPicker.prototype, "handleValueChange", 1);
MoyoColorPicker = __decorateClass([
  n("moyo-color-picker")
], MoyoColorPicker);
